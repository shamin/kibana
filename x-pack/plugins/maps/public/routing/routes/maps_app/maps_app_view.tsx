...
import { AppMountParameters, AppLeaveHandler } from 'kibana/public';
import {
...
import { Filter, IndexPattern, SavedQuery, QueryState } from 'src/plugins/data/public';
import { Adapters } from 'src/plugins/inspector/public';
import { Filter, Query, TimeRange } from 'src/plugins/data/public';
import { QueryStateChange } from 'src/plugins/data/public/query';
import {
  LayerDescriptor,
  MapRefreshConfig,
  MapCenterAndZoom,
...
export class MapsAppView extends React.Component<MapsAppViewProps, MapsAppViewState> {
    ...
    this.props.onAppLeave((actions) => {
      if (this._hasUnsavedChanges()) {
        if (!window.confirm(unsavedChangesWarning)) {
          // TODO: Couldn't find an alternative for this
          return (undefined as unknown) as AppLeaveAction;
        }
      }
  ...
  _onQueryChange = ({
    ...
    // sync globalState
    const updatedGlobalState: { filters: Filter[]; time?: any } = {
